        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects are can return cleanup functions, which can clean up timers using memory, listeners to outside API's, and other functions which may use system resources</li>
                </ul>
                <SampleEffect/>
                <br />
                <SampleEffect/>
...
const SampleEffect = () => {
    ...
    return(
        <div style={{border: '1px dashed black'}} >
            <h2>This component demos effect</h2>
